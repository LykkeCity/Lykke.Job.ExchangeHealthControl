...
using Lykke.Job.ExchangeHealthControl.Core.Domain.Enums;
...
using MoreLinq;
using Instrument = Lykke.Job.ExchangeHealthControl.Core.Domain.Instrument;
...
namespace Lykke.Job.ExchangeHealthControl.Services.Services
{
    public class ExchangeHealthControlService : IExchangeHealthControlService
    {
        ...
        public async Task Poll(string exchangeName, TimeSpan timeout)
        {
            ...
            await _log.WriteInfoAsync(nameof(ExchangeHealthControlService), nameof(Poll),
        ...
        private ExecutionReport CreateExecutionReport(string exchangeName, string instrument, decimal diff)
        {
            ...
            if (quote == null)
            {
                _log.WriteWarningAsync(nameof(ExchangeHealthControlService), nameof(CreateExecutionReport), 
